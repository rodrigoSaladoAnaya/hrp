...
| `src/web` | Panel: issue, mapa con lupa, actividad y hallazgos con filtro por sesión, evolución (línea de tiempo del run sobre el árbol de archivos), dock de sesiones. |
